 ...
 */
// write your code here
func favoriteCharacterName(characterName : String) {
 ...
 */
// write your code here
let nameConstant = "Khaleesi"
var nameVariable = "Quaithe"
favoriteCharacterName(nameConstant)
favoriteCharacterName(nameVariable)
nameVariable = "Quaithe of Asshai"
favoriteCharacterName(nameVariable)
 ...
 */
// write your code here
func favoriteBandRank(band:String, ranking:Int) {
    print("My #\(ranking) favorite band is \(band).")
}
favoriteBandRank("Do As Infinity", ranking: 5)
...
madLib("Geralt", noun: "retire", preposition: "in Toussaint")
 ...
 */
// write your code here
func whatDoesTheBuzzSay() -> String {
    return "Buzz Lightyear to the rescue!"
}
var saying = whatDoesTheBuzzSay()
print(saying)
...
print(returnRandomNumber())

/*: question12
 ### 12. Create a function that takes in a characters name. This function will return back a `String` as follows: "To infinity and beyond, <character name>!". The character name should be returned uppercased.
 */
// write your code here
func toGoWhatAndHow(characterName:String) -> String {
    return "To infinity and beyond, \(characterName)!"
}
toGoWhatAndHow("Woody")
