 ...
 */
// write your code here
func favoriteBand (band: String, ranking: Int) {
    print("My #\(ranking) favorite band is \(band).")
}

favoriteBand("NOFX", ranking: 2)
...
func buzzToTheRescue () -> (String) {
    let rescueString = "Buzz Lightyear to the rescue!"
    return rescueString
}

print(buzzToTheRescue())
 ...
 */
// write your code here
func infinityString (characterName: String) -> String {
    return "To infinity and beyond, \(characterName.uppercaseString)!"
}

print(infinityString("woody"))
